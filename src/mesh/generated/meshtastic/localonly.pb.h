...
typedef struct _meshtastic_LocalModuleConfig {
 ...
 NodeDB.cpp in the device code. */
    ...
    /* The part of the config that is specific to the heartbeat module */
    bool has_heartbeat;
...
#define meshtastic_LocalModuleConfig_heartbeat_tag 14
...
#define meshtastic_LocalModuleConfig_heartbeat_MSGTYPE meshtastic_ModuleConfig_HeartbeatConfig
...
#define meshtastic_LocalModuleConfig_size        625
