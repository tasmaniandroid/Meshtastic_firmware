...
size_t PhoneAPI::getFromRadio(uint8_t *buf)
{
    ...
    case STATE_SEND_MODULECONFIG:
        ...
        case meshtastic_ModuleConfig_heartbeat_tag:
            fromRadioScratch.moduleConfig.which_payload_variant = meshtastic_ModuleConfig_heartbeat_tag;
            fromRadioScratch.moduleConfig.payload_variant.heartbeat = moduleConfig.heartbeat;
            break;
        default:
